...
public class TechnicalCriteriaEngine {
    public TechnicalCriteriaResult evaluate(TechnicalSignals t) {
        ...
        String volume = breakoutRequiresVolume(t) ? breakoutVolumeStatus(t) : "PASS";
    ...
    private String breakoutStatus(TechnicalSignals t) {
        ...
        return nearHigh || (fresh && breakoutVolumeStatus(t).equals("PASS")) ? "PASS" : "FAIL";
    }

    private boolean breakoutRequiresVolume(TechnicalSignals t) {
        if (t == null || t.getBreakoutAnalysis() == null) return false;
        String signal = t.getBreakoutAnalysis().getSignal();
        return "FRESH_BREAKOUT".equals(signal) || "BULLISH_BREAKOUT_CONFIRMED".equals(signal);
    }
