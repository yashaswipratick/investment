...
public class StockAnalysisResultPersistenceService {
    ...
    public Mono<StockAnalysisResult> persist(StockAnalysisResult result) {
        ...
        StockAnalysisResultEntity entity = StockAnalysisResultEntity.builder()
                ...
                .analysisExecutionDate(result.getAnalysisExecutionDate())
                .marketDataLatestDate(result.getMarketDataLatestDate())
                .fundamentalLatestPeriod(result.getFundamentalLatestPeriod())
                ...
                .technicalCriteriaJson(toJson(result.getTechnicalCriteriaResult()))
                .fundamentalCriteriaJson(toJson(result.getFundamentalCriteriaResult()))
                .marcusDecision(result.getMarcusDecision())
