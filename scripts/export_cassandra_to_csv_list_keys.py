...
def export_stock_history(primary_keys, output_directory):
    ...
    Each key gets its own CSV file:
    ...
    try:
        ...
        for primary_key in primary_keys:
            ...
            try:
                ...
                # Build columns dynamically from UDT fields.
                fieldnames = []
        ...
        print(f"Files exported : {total_exported}")
...
"
            "  python3 export_cassandra_to_csv.py "
            "MUNJALAU,RELIANCE,TCS ~/Downloads/cassandra_export"
        )
        sys.exit(1)
